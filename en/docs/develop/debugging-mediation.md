...
2. Launch Visual Studio Code with the [Micro Integrator Extension]({{base_path}}/develop/mi-for-vscode/install-wso2-mi-for-vscode) installed.
...
??? note "Remote Server Debugging"
    Follow the steps below to connect to and debug a remote Micro Integrator server.
